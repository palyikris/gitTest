...
<div id="nev">
    ...
    <a href="messagefeluletmk.php" style="background-color: lightgray;">Kristóf</a>
    <a href="#">Valaki</a>
    <a href="@">Valaki más</a>
    <a href="&">Megint más</a>
</div>
...
<?php 
$sql = "SELECT ido,sender,uzi FROM km ORDER BY ido asc";
...
if($result->num_rows > 0){
 ...
 ?>
    <tr>
        <td colspan="3"><form class="uzenetekform" id="uzenetekformid" action="uzi5.php" method="POST">
