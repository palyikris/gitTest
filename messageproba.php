...
#nev a:hover{
    ...
    <script>
function myFunction() {
fetch("http://www.henifanpage.probaljaki.hu/betolto.php")
    .then((response) => response.text())
    .then((html) => {
        document.getElementById("kijelzoid").innerHTML = html;
    })
}
</script>
</head>
...
<?php 
 ...
 ?>
    <tr>
        <td colspan="3"><form class="uzenetekform" id="uzenetekformid" action="inserteloproba.php" method="POST">
            <input type="text" class="uziinput" name="uzimuzi" id="uziinputid">
            <input type="hidden" class="uziinput" name="token" id="uziinputid1" value="111">
