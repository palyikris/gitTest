...
<div id="nev">
    ...
    <a href="messagefelulet1.php" style="background-color: lightgray;">Kristóf</a>
    <a href="#">Valaki</a>
    <a href="@">Valaki más</a>
    <a href="&">Megint más</a>
</div>
...
if($result->num_rows > 0){
 ...
 ?>
    <tr>
        <td colspan="3"><form class="uzenetekform" id="uzenetekformid" action="uzi1.php" method="POST">
