...
if($result->num_rows > 0){
	while($row = mysqli_fetch_assoc($result)){
		...
		echo "<tr><td class='sor1' title=".$row['ido'].">".$row['uzi']."</td><td>"."</td><td colspan='2' ".">"."</td></tr>";
        }
        else{
            echo "<tr><td".">"."</td><td>"."</td><td class='sor3' title=".$row['ido'].">".$row['uzi']."</td></tr>";
        }
    }
}
?>
</table>
        <form class="uzenetekform" id="uzenetekformid" action="uzi1proba.php" method="POST">
