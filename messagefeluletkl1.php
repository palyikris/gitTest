...
<div id="nev">
    ...
    <a href="messagefelulet.php">Heni</a>
    <a href="messagefeluletkl1.php"style="background-color: lightgray;">Lelle</a>
...
<?php 
$sql = "SELECT ido,sender,uzi FROM kl ORDER BY ido asc";
$result = mysqli_query($link,$sql);
$hour=date("h:i:s");
if($result->num_rows > 0){
	while($row = mysqli_fetch_assoc($result)){
        if($row['sender']=="Lelle"){
		echo "<tr><td class='sor1' title=".$hour.">".$row['uzi']."</td><td>"."</td><td colspan='2' ".">"."</td></tr>";
        }
        else{
            echo "<tr><td".">"."</td><td>"."</td><td class='sor3' title=".$hour.">".$row['uzi']."</td></tr>";
        }
    }
}
 ?>
    <tr>
        <td colspan="3"><form class="uzenetekform" id="uzenetekformid" action="uzi3.php" method="POST">
